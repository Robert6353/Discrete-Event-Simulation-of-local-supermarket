...
class clarks:
    def __init__(self, env):
       ...
       self.line = simpy.Container(env, capacity = 10, init = 0) #No more new customers after 20 in shop
...
Revenue_lost = clarks.lost.level * random.gauss(mean_rev_per_head, std_rev_per_head) + clarks.lost_food.level * random.gauss(10, std_rev_per_head) *2
#Adjust this to a normal distribution
